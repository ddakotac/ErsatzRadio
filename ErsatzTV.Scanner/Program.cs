...
using ErsatzTV.Infrastructure.Audiobookshelf;
using ErsatzTV.Infrastructure.Navidrome;
...
using ErsatzTV.Scanner.Core.Audiobookshelf;
using ErsatzTV.Scanner.Core.Navidrome;
    ...
    private static IHostBuilder CreateHostBuilder(string[] args)
    {
        ...
        return Host.CreateDefaultBuilder(args)
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddScoped<INavidromeSongLibraryScanner, NavidromeSongLibraryScanner>();
                services.AddScoped<INavidromeApiClient, NavidromeApiClient>();
                services.AddScoped<INavidromeSongRepository, NavidromeSongRepository>();
                services.AddScoped<INavidromePathReplacementService, NavidromePathReplacementService>();
                services.AddScoped<INavidromeSecretStore, NavidromeSecretStore>();
                services.AddScoped<IAudiobookshelfTelevisionLibraryScanner, AudiobookshelfTelevisionLibraryScanner>();
                services.AddScoped<IAudiobookshelfApiClient, AudiobookshelfApiClient>();
                services.AddScoped<IAudiobookshelfTelevisionRepository, AudiobookshelfTelevisionRepository>();
                services.AddScoped<IAudiobookshelfPathReplacementService, AudiobookshelfPathReplacementService>();
                services.AddScoped<IAudiobookshelfSecretStore, AudiobookshelfSecretStore>();
